      ...
      <div className="flex h-16 items-center justify-between px-4 lg:px-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative group">
            <button className="flex items-center gap-2 rounded-xl p-1.5 hover:bg-gradient-to-br hover:from-blue-50 hover:to-purple-50 dark:hover:bg-gray-700/50 transition-all">
